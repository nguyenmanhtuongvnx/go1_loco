...
from .go1_loco_terrain_cfg import ROUGH_TERRAINS_CFG  # isort: skip
from .go1_loco_robot_cfg import UNITREE_GO1_CFG  # isort: skip
...
@configclass
class Go1LocoSceneCfg(InteractiveSceneCfg):
    # ground plane
...
class LocomotionEnvCfg(ManagerBasedRLEnvCfg):
    # Scene settings
    scene: Go1LocoSceneCfg = Go1LocoSceneCfg(num_envs=4096, env_spacing=2.5)
    # Basic settings
...
class Go1LocoEnvCfg(LocomotionEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
        
        # soften the rough terrain profile for the smaller robot.
        ...
        if terrain_generator is not None:
            ...
            if random_rough is not None:
                random_rough.noise_range = (0.01, 0.06)
