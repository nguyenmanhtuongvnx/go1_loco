...
All the environments are registered in the `go1_loco` extension. They start
...
import go1_loco.tasks  # noqa: F401


def main():
    """Print all environments registered in `go1_loco` extension."""
